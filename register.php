			...
			<div id="main-content-head">
				...
				<div class="visualization">
					<div class="header-title gni">
						<div class="part-1">
							<i class="fa fa-dollar-sign"></i><b> GNI Per Capita</b>
						</div>
	...
	<script>
		...
		$.get('https://api.worldbank.org/v2/countries/ao/indicators/NY.GNP.MKTP.KD?format=json&date=2010:2018', function(data) {
			/*optional stuff to do after success */
		}).done(function(data){
			drawGraph($("#gni canvas"), data, "line", "GNI", "#F2994A");
		});
